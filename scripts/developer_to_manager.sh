...
# 作業種別を自動検出
WORK_TYPE=$(source "$WORKSPACE_DIR/scripts/detect_work_type.sh" && detect_work_type "$MESSAGE" 4 1)
...
tmux send-keys -t claude_workspace:0.1 "cat \"$WORKSPACE_DIR/tmp/tmp_developer.txt\""
