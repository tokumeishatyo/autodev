...
WORK_TYPE=$(source "$WORKSPACE_DIR/scripts/detect_work_type.sh" && detect_work_type "$MESSAGE" 1 4)
...
tmux send-keys -t claude_workspace:0.3 "cat \"$WORKSPACE_DIR/tmp/tmp_manager.txt\""
